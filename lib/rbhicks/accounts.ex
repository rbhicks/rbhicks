defmodule Rbhicks.Accounts do
  ...
  alias Rbhicks.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Rbhicks.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Rbhicks.Accounts.User.password_changeset/3` for a list of supported options.
